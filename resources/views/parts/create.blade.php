                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{route('part.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div  class="my-3">
                                <input type="file" class="border-gray-300 shadow-sm w-1/2 rounded-lg" id="image" name="image" value="{{old('image')}}">
                                @error('image')
                                    <p class="text-red-400 font-medium">{{$message}}</p>
                                @enderror
                            </div>
                            ...
                            <div  class="my-3">
                                <input placeholder="Enter Mrp Price" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg" id="" name="mrp" value="{{old('mrp')}}">
                                @error('mrp')
                                    <p class="text-red-400 font-medium">{{$message}}</p>
                                @enderror
                            </div>
                            ...
                            <div  class="my-3">
                                <input placeholder="Enter Sale Price" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg" id="" name="price" value="{{old('price')}}">
                                @error('price')
                                    <p class="text-red-400 font-medium">{{$message}}</p>
                                @enderror
                            </div>
                            ...
                            <div  class="my-3">
                                <input placeholder="Enter Name" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg" id="" name="qty" value="{{old('qty')}}">
                                @error('qty')
                                    <p class="text-red-400 font-medium">{{$message}}</p>
                                @enderror
                            </div>
