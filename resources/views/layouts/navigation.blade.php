<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto my-3 px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex flex-wrap">
                <!-- Logo -->
                {{-- <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <p class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200">Drinktech</p>
                    </a>
                </div> --}}
                ...
                @can('view recharges')
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('recharge.index')" :active="request()->routeIs('recharge.index')">
                        {{ __('Recharge Rental') }}
                    </x-nav-link>
                </div>
                @endcan
                ...
                @can('view partsales')
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('partsale.index')" :active="request()->routeIs('partsale.index')">
                        {{ __('PartSale') }}
                    </x-nav-link>
                </div>
                @endcan
