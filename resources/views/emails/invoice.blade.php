...
<div class="container">
    ...
    <div class="bill-info">
        <div>
            <h3>Bill To:</h3>
            <p><strong>Customer Name:</strong> {{ $c_name }}</p>
            {{-- <p><strong>Customer Name:</strong> {{ $product_mrp }}</p> --}}
            <p><strong>Email:</strong> {{ $c_email}}</p>
            <p><strong>Address:</strong> {{ $c_address}}</p>
            <p><strong>Pincode:</strong> {{ $c_pin_code}}</p>
            <p><strong>Mobile No:</strong> {{$c_mobile}}</p>
            <p><strong>Alternate Mobile No:</strong> {{$c_alt_mobile}}</p>
        </div>
        <div>
            <h3>Transaction Info:</h3>
            <p><strong>Date:</strong> {{$billed_date}}</p>
    ...
    <div class="total-summary">
        <div><strong>Total MRP:</strong> {{$mrp}}</div>
        <div><strong>Total Sale Price:</strong> {{$price}}</div>
        <div><strong>Total Discount:</strong> {{$discount}}</div>
        <div><strong>Total Quantity:</strong> {{$qty}}</div>
        <div><strong>Total Billed Price:</strong> {{$final_amt}}</div>
    </div>
